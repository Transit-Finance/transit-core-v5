...
contract UniswapV2Router is BaseCore {
    ...
    function exactInputV2Swap(ExactInputV2SwapParams calldata exactInput, uint256 deadline) external payable nonReentrant whenNotPaused returns (uint256 returnAmount) {
